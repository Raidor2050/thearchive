...
const narrativeScenes = [
  ...
  {id:'intro2',chapter:'ARCHIVE // OPEN',speaker:'* GUIDE',text:'Welcome! Glad you dropped by.\\nI have been keeping a few of Raiyan\'s better stories safe.',next:'intro3'},
  {id:'intro3',chapter:'ARCHIVE // OPEN',speaker:'* GUIDE',text:"Some are about partnerships. Some are about the quiet work behind them.\\nWant to dive into Raiyan's lore?",next:'introChoice',secret:1},
  {id:'introChoice',chapter:'ARCHIVE // OPEN',speaker:'* GUIDE',text:'No rush. I can show you the path, or you can wander on your own.',choices:[{label:'YES — SHOW ME',next:'beginning1'},{label:'NO — I WILL LOOK AROUND',next:'hub'}]},
  {id:'hub',chapter:'ARCHIVE // INDEX',speaker:'* GUIDE',text:'The archive has two reliable trails. One explains where the work began; the other explains how it is done.',choices:[{label:'HOW THE JOURNEY STARTED',next:'beginning1'},{label:'HOW PARTNERSHIPS ARE BUILT',next:'ops1'}]},
  ...
  {id:'journeyChoice',chapter:'JOURNEY // CHECKPOINT',speaker:'* GUIDE',text:'That early habit still shapes the work. Want to see how the system grew, or what it produced?',choices:[{label:'HOW THE SYSTEM SCALED',next:'scale1'},{label:'SEE PRACTICAL OUTCOMES',next:'outcomes1'}]},
  ...
  {id:'scaleChoice',chapter:'JOURNEY // CHECKPOINT',speaker:'* GUIDE',text:'A process is only useful if it helps people make better decisions. The rest is best heard from Raiyan himself.',next:'finalContact'},
  ...
  {id:'opsChoice',chapter:'PLAYBOOK // CHECKPOINT',speaker:'* GUIDE',text:'That is the repeatable loop: source, connect, qualify, activate, learn and improve.\\nIt works best when the conversation stays human.',next:'finalContact'},
  ...
  {id:'outcomesChoice',chapter:'FIELD NOTES // CHECKPOINT',speaker:'* GUIDE',text:'The pattern is consistent: thoughtful sourcing, clear communication and dependable follow-through.',next:'finalContact'},
  ...
  {id:'craft3',chapter:'SYSTEMS // 03',speaker:'* GUIDE',text:'The point is not the tool itself. It is using the right record at the right moment, so partners receive useful follow-through rather than noise.',next:'finalContact',secret:6},
  {id:'finalContact',chapter:'ARCHIVE // LAST PAGE',speaker:'* GUIDE',text:'That is the shape of it.\\nSo, ready to contact Raiyan?',choices:[{label:'YES — OPEN A CHANNEL',next:'contact'},{label:'NO — I WILL KEEP EXPLORING',next:'hub'}]},
