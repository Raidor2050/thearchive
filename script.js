const narrativeScenes = [
  ...
  {id:'intro3d',chapter:'ARCHIVE // OPEN',speaker:'* GUIDE',text:"Want to dive into Raiyan's lore?",next:'introChoice'},
  {id:'introChoice',chapter:'ARCHIVE // OPEN',speaker:'* GUIDE',text:'No rush.',next:'introChoice2'},
  {id:'introChoice2',chapter:'ARCHIVE // OPEN',speaker:'* GUIDE',text:'I can show you the path, or you can wander.',choices:[{label:'YES — SHOW ME',next:'beginning1'},{label:'NO — I WILL LOOK AROUND',next:'hub'}]},
  ...
  {id:'beginning3',chapter:'JOURNEY // 03',speaker:'* GUIDE',text:'That made outreach a useful first conversation.',next:'beginning3b'},
  {id:'beginning3b',chapter:'JOURNEY // 03',speaker:'* GUIDE',text:'The goal was fit before volume.',next:'beginning4'},
  {id:'beginning4',chapter:'JOURNEY // 04',speaker:'* GUIDE',text:'When a partner replied, the real work began.',next:'beginning4b',secret:2},
  ...
  {id:'opsChoice2',chapter:'PLAYBOOK // CHECKPOINT',speaker:'* GUIDE',text:'It works best when the conversation stays human.',next:'finalContact'},
