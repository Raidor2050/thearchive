...
const narrativeScenes = [
  ...
  {id:'introChoice',chapter:'ARCHIVE // OPEN',speaker:'* GUIDE',text:'We can follow the journey from the beginning, or skip to the operating playbook.',choices:[{label:'START AT THE BEGINNING',next:'beginning1'},{label:'SHOW ME THE PLAYBOOK',next:'ops1'},{label:'LET ME EXPLORE',next:'hub'}]},
  ...
  {id:'scaleChoice',chapter:'JOURNEY // CHECKPOINT',speaker:'* GUIDE',text:'A process is only useful if it helps people make better decisions. Want to see the decision loop?',choices:[{label:'SHOW THE PLAYBOOK',next:'ops1'},{label:'SHOW THE RESULTS',next:'outcomes1'},{label:'OPEN THE TOOLKIT',next:'toolHint'}]},
  ...
  {id:'profileHint',chapter:'ARCHIVE NOTE // 01',speaker:'* GUIDE',text:'The profile holds the professional record.\\nThis story is the reasoning behind it.',secret:6,next:'hub'},
  {id:'toolHint',chapter:'ARCHIVE NOTE // 02',speaker:'* GUIDE',text:'The toolkit is here because good partnership work needs reliable systems, not just good instincts.',secret:7,next:'hub'}
];
